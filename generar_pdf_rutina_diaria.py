...
def main():
    ...
    timeline(pdf, [
        ...
        ("05:45", "Pre-entreno", "Frutillas 200g + miel 10g + cafe 150ml + agua 300ml"),
        ("06:30", "Salir al gym", ""),
        ...
        ("08:00", "Post-entreno", "Whey 35g + agua 300ml + frutillas 100g"),
    ...
    timeline(pdf, [
        ...
        ("12:30", "PRE-ENTRENO LIVIANO", "Frutillas 200g + miel 10g + cafe + agua con sal 400ml. NO comer solido pesado 11-14h"),
        ("13:30", "Salir al gym", ""),
        ("14:00", "ENTRENO Dia B", ""),
