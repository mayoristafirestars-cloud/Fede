...
def main():
    ...
    render_day(pdf, "LUNES",
               ...
               [
                   ("06:00", "water",  "Despertar", "Vaso 300 ml + pizca de sal"),
                   ("06:05", "task",   "Bano rapido y ropa gym", ""),
                   ("06:30", "meal",   "Pre-entreno", "Media banana 80 g + cafe 150 ml + agua con sal 300 ml"),
    ...
    render_day(pdf, "MARTES",
               ...
               [
                   ("06:00", "water",  "Despertar", "Agua 300 ml + sal"),
                   ("06:30", "meal",   "Pre-entreno", "Pasas de uva 30 g (punadito) + cafe 150 ml + agua con sal 300 ml"),
                   ("06:30", "task",   "Salir al gym", ""),
    ...
    render_day(pdf, "JUEVES",
               "GYM 07:00  ·  Dia A: Empuje + Bisagra",
               [
                   ("06:00", "water",  "Despertar + sal", ""),
                   ("06:30", "meal",   "Pre-entreno", "Media banana 80 g + cafe + agua con sal"),
    ...
    render_day(pdf, "VIERNES",
               ...
               [
                   ("06:00", "water",  "Despertar", "Agua 400 ml"),
                   ("06:30", "meal",   "DESAYUNO Primal", "4 huevos duros + queso port salut 30 g + palta 80 g + tomate 100 g + oliva 5 ml"),
