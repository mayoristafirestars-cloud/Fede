# Seguimiento de cartera — Fede

*Registro de ejecución del plan (cartera-cedears-julio-2026.md). Se actualiza con cada tanda de compras.*

---

## Compra #1 — 3 de julio de 2026 (CEDEARs en pesos)

| Ticker | Nominales | Precio ARS | Invertido ARS | Precio implícito NY (aprox) | Ola del plan |
|---|---|---|---|---|---|
| AMZN | 10 | 2.660 | 26.600 | ~243 USD ✓ (CCL ~1.575) | Ola 2 |
| AVGO | 2 | 15.740 | 31.480 | ~395-405 USD ✓ | Ola 2 |
| MSFT | 1 | 20.150 | 20.150 | ~384-395 USD — ¡puede estar ya en zona de tramo 2 (375-385)! | Ola 1 |
| SPGI | 1 | 15.120 | 15.120 | ~433 USD ✓ | Ola 1 |
| **Total** | | | **93.350** | | |

**Verificación importante lograda con esta compra:** el precio pagado por SPGI (15.120 ARS) solo es coherente con **ratio 45:1** (con 20:1 implicaría un CCL imposible de ~700). ✅ **Queda confirmado SPGI = 45:1** — se resuelve la duda que teníamos marcada.

### Pesos actuales vs objetivo (se normalizan al completar las olas)

| Posición | Peso actual | Objetivo | Acción |
|---|---|---|---|
| AVGO | 33,7% | 7% | NO agregar más — que el resto la alcance |
| AMZN | 28,5% | 8% | NO agregar más por ahora |
| MSFT | 21,6% | 9% | OK, puede crecer (ver nota tramo 2) |
| SPGI | 16,2% | 5% | NO agregar más por ahora |

### Pendiente de la Ola 1 (próximas compras, precios aprox. a CCL ~1.573 — recalcular el día de la orden)

| Ticker | Ratio | Precio aprox. por CEDEAR | Nota |
|---|---|---|---|
| NU | 2:1 | ~10.600 ARS | Verificar precio NY (~13,5 USD) |
| PEP | 18:1 | ~12.300 ARS | |
| NKE | 12:1 | ~5.500 ARS | La más accesible |
| GLD | 50:1 | consultar en broker | Precio del ETF no verificado hoy |
| SPY | 20:1 | ~59.000 ARS | CEDEAR "grande": si el capital no alcanza, se difiere sin problema |

### Órdenes limitadas de tramo 2 a dejar puestas (en ARS, a CCL 1.573 — recalcular si el CCL se mueve >2%)

| Ticker | Banda tramo 2 (USD) | Límite aprox. ARS |
|---|---|---|
| MSFT | 375–385 | ~19.700–20.200 |
| AMZN | 220–228 | ~2.400–2.490 |
| AVGO | 365–375 | ~14.700–15.100 |
| SPGI | 395–410 | ~13.900–14.400 |
