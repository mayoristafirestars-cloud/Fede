...
RECORDATORIOS = [
    ...
    (0, "18:30", "🐟 Cena en 30 min: pescado 200 g + verdura 150 g + verdura 70 g + anchoas 20 g + huevo duro + oliva 12 ml.", 470, 55, 0),
    ...
    (1, "16:00", "🥛 Merienda en 30 min: cottage 200 g + fruta 30 g + canela.", 180, 24, 0),
    (1, "18:30", "🐟 Cena en 30 min: pescado 180 g + verdura salteada 150 g + hongos 80 g + oliva 12 ml.", 430, 40, 0),
    ...
    (2, "09:30", "🥛 Media mañana en 30 min: yogur griego 200 g + nueces 10 g + fruta 20 g.", 250, 18, 0),
    (2, "12:30", "🍽️ Almuerzo en 30 min: pescado 180 g + 2 huevos duros + verdura 150 g + queso 30 g + ensalada + palta 60 g + oliva 15 ml.", 620, 62, 0),
    ...
    (2, "18:30", "🐟 Cena en 30 min: pescado 120 g + tomate 100 g + palta 60 g + aceitunas 15 g + oliva + limón.", 450, 40, 0),
    ...
    (3, "09:00", "🍳 Desayuno diferente en 30 min: yogur griego 200 g + fruta 100 g + almendras 15 g + canela + 3 huevos duros aparte.", 550, 40, 0),
    ...
    (3, "16:00", "🥛 Merienda en 30 min: yogur griego 170 g + nueces 12 g + fruta 20 g.", 180, 15, 0),
    (3, "18:30", "🐟 Cena en 30 min: pescado 200 g + verdura 200 g + huevo duro + anchoas 20 g + oliva 12 ml.", 450, 50, 0),
    ...
    (4, "10:00", "🥛 Media mañana en 30 min: yogur griego 150 g + nueces 10 g + fruta 30 g.", 190, 15, 0),
    ...
    (5, "09:30", "🥛 Media mañana en 30 min: cottage 150 g + fruta 50 g + nueces 7 g.", 180, 22, 0),
    (5, "12:30", "🍽️ Almuerzo en 30 min: pollo 220 g + verdura 150 g + verduras hervidas 100 g + ensalada + palta 40 g + oliva 12 ml.", 500, 55, 0),
    (5, "13:00", "🚴 Bici 40 min en 30 min. Zona 2, ruta plana.", 0, 0, 300),
    (5, "13:30", "☕ ¡Último mate!", 0, 0, 0),
    (5, "16:00", "🐟 Merienda PESCADO en 30 min: pescado 100 g + palta 50 g + tomate cherry 80 g + galleta de arroz 1.", 260, 22, 0),
    (5, "16:30", "⭐ Hobby / familia.", 0, 0, 0),
    (5, "18:30", "🍽️ Cena en 30 min: pollo 180 g + 2 huevos duros + queso 25 g + verdura al vapor 150 g + hongos + anchoas 15 g + oliva.", 500, 55, 0),
    ...
    (6, "18:30", "🍽️ Cena Caesar en 30 min: pollo 180 g + hojas verdes + huevo duro + anchoas 20 g + parmesano 15 g + aderezo.", 470, 40, 0),
