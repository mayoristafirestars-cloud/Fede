...
| Suplemento | Dosis sugerida | Horario | Desde cuando | Motivo | Estado |
|---|---|---|---|---|---|
| Creatina monohidrato | 3–5 g/dia | Post-entreno (dias gym) o manana (dias descanso) | A partir del 21/04/2026 | Preservacion y ganancia de fuerza muscular en contexto de deficit calorico. Evidencia solida en poblacion de 40+. Sin contraindicaciones conocidas para Fede. | VALIDAR CON MEDICO post-analisis de funcion renal |
| Omega-3 (EPA+DHA) | 2–3 g/dia (fish oil concentrado) | Con el almuerzo o la cena | A partir del 21/04/2026 | Riesgo cardiovascular moderado-alto (antecedente paterno + obesidad abdominal). Efecto antiinflamatorio y sobre triglicer­idos. | VALIDAR CON MEDICO — pedir lipidograma primero |
| Vitamina D3 | 2.000–4.000 UI/dia | Con el desayuno (con grasa para absorcion — el huevo del desayuno alcanza) | A partir del 21/04/2026 | Deficiencia muy prevalente en adultos de interior/ciudad con poca exposicion solar. Impacta fuerza muscular, inmunidad y estado de animo. | VALIDAR CON MEDICO — dosificar segun 25-OH-vitamina D en analisis |
| Proteina en polvo (whey o blend plant-based) | 35 g post-entreno | Dentro de los 60 min de terminar el gym | A partir del 21/04/2026 | Herramienta para alcanzar el objetivo proteico (190 g/dia) dado el perfil de poco tiempo para cocinar. No es medicamento, es alimento concentrado. | Sin restriccion medica activa. Elegir opcion sin azucar agregada ni edulcorantes en exceso. |

---

## Notas generales

- La creatina y el omega-3 son los suplementos con mayor respaldo para el perfil de Fede (47 anos, deficit calorico, entreno de fuerza, riesgo cardiovascular).
- La vitamina D se sugiere empiricamente — la dosis exacta depende del resultado del analisis de sangre (25-OH-vitamina D). Si el medico no la incluyo en el pedido de estudios, solicitarla.
