...
PLAN = {
    "LUNES": {
        ...
        "prot_total": 181,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno · Huevos clásicos",
             "kcal": 570, "prot": 32,
             "ingredientes": ["4 huevos duros", "Palta 90 g", "Tomate 100 g",
            ...
            {"hora": "12:30", "icono": "[ALM]", "nombre": "Almuerzo · Pollo grillado",
             "kcal": 700, "prot": 78,
             "ingredientes": ["Pollo grillado 250 g", "Papa hervida 100 g",
                              "Ensalada mixta (hojas + tomate + zanahoria + pepino)",
            ...
            {"hora": "16:30", "icono": "[MER-CENA]", "nombre": "Merienda-cena · Yogur y huevos",
             "kcal": 300, "prot": 33,
    ...
    "MARTES": {
        ...
        "prot_total": 183,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno · Tortilla con jamón",
             "kcal": 590, "prot": 34,
             "ingredientes": ["Tortilla de 3 huevos + queso rallado 20 g",
                              "Jamón cocido magro 30 g", "Palta 80 g",
                              "Tomate 100 g", "Oliva 5 ml"]},
            {"hora": "07:30", "icono": "[POST]", "nombre": "Post-entreno",
             "kcal": 210, "prot": 28,
             "ingredientes": ["Whey 35 g", "Creatina 5 g", "Banana chica 80 g"]},
            {"hora": "09:15", "icono": "[SUPL]", "nombre": "Suplementos",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Vit D3", "Omega-3"]},
            {"hora": "12:30", "icono": "[ALM]", "nombre": "Almuerzo · Milanesas al horno",
             "kcal": 700, "prot": 78,
             "ingredientes": ["Milanesas de pollo al horno 250 g (rebozadas con harina de almendras)",
                              "Boniato al horno 100 g", "Ensalada verde con rúcula",
                              "Palta 50 g", "Oliva 15 ml + limón"]},
            {"hora": "13:30", "icono": "[MATE]", "nombre": "Último mate del día",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Después: solo agua o infusiones sin cafeína"]},
            {"hora": "16:30", "icono": "[MER-CENA]", "nombre": "Merienda-cena · Cottage con frutillas",
             "kcal": 300, "prot": 33,
             "ingredientes": ["Cottage 200 g", "2 huevos duros",
                              "Frutillas 30 g", "Nueces 10 g", "Canela"]},
            {"hora": "21:30", "icono": "[SNACK]", "nombre": "Snack ancla (opcional)",
             "kcal": 100, "prot": 10,
             "ingredientes": ["Yogur griego 100 g", "Chía 5 g", "Magnesio 300 mg"]},
        ]
    ...
    "MIÉRCOLES": {
        ...
        "prot_total": 168,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno · Ricota mediterránea",
             "kcal": 550, "prot": 32,
             "ingredientes": ["Ricota 100 g batida con hierbas",
                              "2 huevos poché", "Palta 60 g",
                              "Tomate 100 g", "Semillas mixtas 10 g"]},
            ...
            {"hora": "12:30", "icono": "[ALM]", "nombre": "Almuerzo · Ensalada de atún",
             "kcal": 680, "prot": 72,
             "ingredientes": ["Atún al natural 180 g", "2 huevos duros",
                              "Espinaca 150 g", "Queso 30 g",
                              "Palta 50 g", "Oliva 12 ml + limón"]},
            ...
            {"hora": "13:30", "icono": "[MATE]", "nombre": "Último mate del día",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Después: solo agua o infusiones sin cafeína"]},
            {"hora": "16:30", "icono": "[MER-CENA]", "nombre": "Merienda-cena · Sardinas con palta",
             "kcal": 300, "prot": 32,
             "ingredientes": ["Sardinas al natural 100 g", "Palta 50 g",
                              "Tomate 100 g", "Aceitunas 10 g",
                              "Oliva 5 ml + limón"]},
            {"hora": "21:30", "icono": "[SNACK]", "nombre": "Snack ancla (opcional)",
             "kcal": 100, "prot": 10,
             "ingredientes": ["Yogur griego 100 g", "Chía 5 g", "Magnesio 300 mg"]},
    ...
    "JUEVES": {
        ...
        "prot_total": 188,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno DULCE · Yogur bowl",
             "kcal": 550, "prot": 40,
             "ingredientes": ["Yogur griego 200 g", "Frutillas 100 g",
            ...
            {"hora": "07:30", "icono": "[POST]", "nombre": "Post-entreno",
             "kcal": 210, "prot": 28,
             "ingredientes": ["Whey 35 g", "Creatina 5 g", "Banana chica 80 g"]},
            {"hora": "12:30", "icono": "[ALM]", "nombre": "Almuerzo · Pollo mostaza y limón",
             "kcal": 700, "prot": 78,
             "ingredientes": ["Pollo mostaza y limón 250 g", "Papas al horno 100 g",
                              "Ensalada nicoise (hojas + tomate + huevo)",
                              "Palta 50 g", "Oliva 12 ml"]},
            {"hora": "13:30", "icono": "[MATE]", "nombre": "Último mate del día",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Después: solo agua o infusiones sin cafeína"]},
            {"hora": "16:30", "icono": "[MER-CENA]", "nombre": "Merienda-cena · Tabla mediterránea",
             "kcal": 300, "prot": 32,
             "ingredientes": ["Queso feta o port salut 60 g", "Pavita fiambre 60 g",
                              "Aceitunas 15 g", "Tomate cherry 80 g",
                              "Palta 40 g", "Nueces 10 g"]},
            {"hora": "21:30", "icono": "[SNACK]", "nombre": "Snack ancla (opcional)",
             "kcal": 100, "prot": 10,
             "ingredientes": ["Yogur griego 100 g", "Chía 5 g", "Magnesio 300 mg"]},
        ]
    ...
    "VIERNES": {
        ...
        "prot_total": 154,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno · Omelette con espinaca",
             "kcal": 585, "prot": 35,
             "ingredientes": ["Omelette 4 huevos + espinaca salteada",
                              "Queso 30 g", "Palta 80 g",
                              "Tomate 100 g", "Oliva 5 ml"]},
            {"hora": "06:15", "icono": "[SUPL]", "nombre": "Suplementos",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Vit D3", "Omega-3"]},
            ...
            {"hora": "15:30", "icono": "[ALM]", "nombre": "Almuerzo · Bowl con quinoa",
             "kcal": 620, "prot": 60,
             "ingredientes": ["Pollo grillado 220 g", "Quinoa cocida 100 g",
                              "Ensalada verde + rúcula", "Palta 60 g",
                              "Almendras 10 g", "Oliva 12 ml"]},
            {"hora": "21:30", "icono": "[SNACK]", "nombre": "Snack ancla (opcional)",
             "kcal": 100, "prot": 10,
             "ingredientes": ["Yogur griego 100 g", "Chía 5 g", "Magnesio 300 mg"]},
        ]
    ...
    "SÁBADO": {
        ...
        "prot_total": 172,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno · Revueltos con jamón",
             "kcal": 500, "prot": 32,
             "ingredientes": ["3 huevos revueltos", "Jamón cocido magro 30 g",
            ...
            {"hora": "09:30", "icono": "[MM]", "nombre": "Media mañana",
             ...
             "ingredientes": ["Cottage 200 g", "Fruta frutillas 50 g",
                              "Nueces 7 g", "Canela"]},
            {"hora": "12:30", "icono": "[ALM]", "nombre": "Almuerzo · Wok de pollo",
             "kcal": 650, "prot": 75,
             "ingredientes": ["Wok pollo 250 g (soja baja sodio + jengibre + ajo)",
                              "Brócoli 150 g", "Zapallo hervido 100 g",
                              "Palta 40 g", "Ajonjolí + oliva 12 ml"]},
            {"hora": "13:00", "icono": "[BICI]", "nombre": "Bici 40 min Zona 2",
             "kcal": 0, "prot": 0,
            ...
            {"hora": "13:30", "icono": "[MATE]", "nombre": "Último mate del día",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Después: solo agua o infusiones sin cafeína"]},
            {"hora": "16:30", "icono": "[MER-CENA]", "nombre": "Merienda-cena · Sardinas gourmet",
             "kcal": 320, "prot": 30,
             "ingredientes": ["Sardinas 120 g", "Palta 50 g",
                              "Tomate cherry 80 g", "Galleta de arroz 1",
                              "Oliva 5 ml + limón"]},
            {"hora": "21:30", "icono": "[SNACK]", "nombre": "Snack ancla (opcional)",
             "kcal": 100, "prot": 10,
             "ingredientes": ["Yogur griego 100 g", "Chía 5 g", "Magnesio 300 mg"]},
    ...
    "DOMINGO": {
        ...
        "prot_total": 155,
        "comidas": [
            {"hora": "06:00", "icono": "[DES]", "nombre": "Desayuno · Huevos poché con feta",
             "kcal": 500, "prot": 28,
             "ingredientes": ["3 huevos poché", "Palta 60 g",
                              "Tomate 100 g", "Queso feta o cottage 30 g",
                              "Semillas mixtas + oliva 5 ml"]},
            {"hora": "06:15", "icono": "[SUPL]", "nombre": "Suplementos",
             "kcal": 0, "prot": 0,
             "ingredientes": ["Vit D3", "Omega-3", "Creatina 5 g"]},
            ...
            {"hora": "16:30", "icono": "[MER-CENA]", "nombre": "Merienda-cena · Atún con palta",
             "kcal": 300, "prot": 32,
             "ingredientes": ["Atún al natural 120 g", "Palta 50 g",
                              "Tomate 100 g", "1 huevo duro",
                              "Aceitunas 10 g + oliva 5 ml"]},
            {"hora": "21:30", "icono": "[SNACK]", "nombre": "Snack ancla (opcional)",
             "kcal": 100, "prot": 10,
             "ingredientes": ["Yogur griego 100 g", "Chía 5 g", "Magnesio 300 mg",
