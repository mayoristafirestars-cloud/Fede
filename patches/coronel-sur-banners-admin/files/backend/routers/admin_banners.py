...
BANNERS_DEFAULT: list[dict] = [
    ...
    },
    {
        ...
        "orden": 2,
        "activo": True,
        "titulo": "Librería Escolar<br>y Oficina",
        "subtitulo": "Cuadernos, carpetas, útiles y más. Los mejores precios de la ciudad.",
        "tag": "📚 Todo para estudiar",
        "emoji": "📚",
        "bg_image": "https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=1280&q=80",
        "bg_color": "#3483FA",
        "overlay_from": "rgba(52,131,250,.82)",
        "overlay_to": "rgba(26,63,139,.9)",
        "btn_text": "Explorar →",
        "btn_link": "#prods-container",
        "btn_color": "#1A3F8B",
    },
    {
        ...
        "subtitulo": "Te lo llevamos sin costo extra en la ciudad.",
        "tag": "🚚 Delivery gratis",
        "emoji": "🚚",
        "bg_image": "",
        "bg_color": "#00A650",
    ...
    },
    {
        ...
        "subtitulo": "Activá el modo mayorista arriba para ver precios especiales.",
        "tag": "🏷️ Precios especiales",
        "emoji": "🏷️",
        "bg_image": "",
        "bg_color": "#7B2D8E",
        "overlay_from": "#7B2D8E",
