...
app = FastAPI(title="Coronel Sur", version="1.1.0")

# Middleware de headers de seguridad en todas las respuestas.
...
def startup():
    ...
    try:
        ...
        print(f"Aviso: no se pudieron limpiar sesiones viejas: {e}")
...
def listar_productos(rubro: str = None, buscar: str = None, limit: int = 50):
    ...
    try:
        ...
        # Limit validado — sin interpolación de strings.
